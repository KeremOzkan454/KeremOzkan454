...
# 💫 Hakkımda:
Siber güvenlik, bug bounty, yapay zeka ve API gibi alanlar hakkında merakı olan **9 yaşından beri programlama ile uğraşan** bir liseliyim. Gelecekte **yapay zeka mühendisi** olmak için çalışıyorum.
