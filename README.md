...
# 💫 Hakkımda:
Azure cloud teknolojileri, siber güvenlik, bug bounty, yapay zeka ve API gibi alanlar hakkında merakı olan **9 yaşından beri programlama ile uğraşan** bir liseliyim. Gelecekte **Azure Security Engineer** olmak için AZ-900 , AZ-500 ve AZ-104 sertifikalarını almayı hedefliyorum.
# 💻 Yazılım Bilgim:
...
# Sertifikalarım:
[![Sertifikalarımı Görüntüle](https://img.shields.io/badge/Sertifikalar%C4%B1m%C4%B1%20G%C3%B6r%C3%BCnt%C3%BCle-blue?style=flat-square)](/python_basic_certificate.png)
...
![](https://github-contributor-stats.vercel.app/api?username=KeremOzkan454&limit=5&theme=nightowl&combine_all_yearly_contributions=true)

---
[![](https://visitcount.itsvg.in/api?id=KeremOzkan454&icon=6&color=3)](https://visitcount.itsvg.in)
